...
class PreferencesControllerTest < ActionController::TestCase
  ...
  test "should create preference" do
    assert_difference('Preference.count') do
      post :create, preference: { Client_id: @preference.Client_id, brand: @preference.brand, color: @preference.color, theme: @preference.theme }
    end
  ...
  test "should update preference" do
    patch :update, id: @preference, preference: { Client_id: @preference.Client_id, brand: @preference.brand, color: @preference.color, theme: @preference.theme }
    assert_redirected_to preference_path(assigns(:preference))
  end
